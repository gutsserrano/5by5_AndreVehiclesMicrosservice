...
namespace APIAndreVehicles.DataBaseManager.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarsController : ControllerBase
    {
        private readonly APIAndreVehiclesDataBaseManagerContext _context;

        public CarsController(APIAndreVehiclesDataBaseManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Car>> PostCar(Car car)
        {
          if (_context.Car == null)
          {
              return Problem("Entity set 'APIAndreVehiclesDataBaseManagerContext.Car'  is null.");
          }
